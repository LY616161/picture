package com.so.picture.movie.entry;

import com.so.picture.movie.utils.Constant;
import com.so.picture.movie.utils.JsonUtil;
...
public class MsgLog {
    ...
    public MsgLog(String msgId, Object msg, String exchange, String routingKey) {
        ...
        this.nextTryTime = ( new Date(date .getTime() + 300000));
}
